/*
 * Schwung Plugin API v1/v2 — vendored copy.
 *
 * Mirrors schwung/src/host/plugin_api_v1.h. Keep in sync when adding
 * new host callbacks. Only the v2 + host_api_v1 surfaces are actually
 * used by this module.
 */
